 ...
 *
 * Usage:  node tests/dom/whatsnew.mjs
 */
...
/* A changelog to serve. Shaped exactly like tools/release/changelog.mjs writes it. */
const LOG = {
...
const banners = await import("../../src/ui/shell/banners.js");
