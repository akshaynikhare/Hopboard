 ...
 *
 *   node tools/release/manifest.mjs <scoop|homebrew|aur|all> <vX.Y.Z>
 *   node tools/release/manifest.mjs publish <vX.Y.Z>     open the PRs (CI only)
 *
...
if (!command || !rawTag) {
  console.error("usage: node tools/release/manifest.mjs <scoop|homebrew|aur|all|publish> <vX.Y.Z>");
  process.exit(2);
}
...
function publish() {
  ...
  Not pushed automatically. See the comment in tools/release/manifest.mjs.`);
}
