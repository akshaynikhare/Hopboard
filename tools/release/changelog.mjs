 ...
 *                   ui/features/whatsNew.js so a returning user is told what changed
 *
 ...
 *
 * Usage:
 *   node tools/release/changelog.mjs              write both files
 *   node tools/release/changelog.mjs --check      exit 1 if they are out of date
 *   node tools/release/changelog.mjs --next v1.2.0  treat unreleased work as that version
 */
